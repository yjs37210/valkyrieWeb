...
<!-- 	<script src="js/jquery-3.5.1.js"></script> -->
	...
	$(function(){
		$('#left').on('click',function(){
			$.ajax({
				url:'ranking_dayAjax.do?direction=left&dDay='+$('#dDay').html(),
				dataType:'json',
				success:function(list){
					...
					let html = '';
					 for(let i = 0; i < list.length; i++){
						 ...
						 html += '<td class="tg-3yw0"> '+list[i].dTime+'</td>';
						 html += '</tr>';
					 }
					 if(list.length == 0){
						 html += '<tr>';
						 html += '<td class="tg-3yw0">0</td>';
						 html += '<td class="tg-s3eb">-</td>';
						 html += '<td class="tg-3yw0">-</td>';
						 html += '</tr>';
					 }
					 console.log(html);
					 $('#rankingList').html(html);
					 $('#dDay').html(list[0].dDay);
	...
	$(function(){
		$('#right').on('click',function(){
			$.ajax({
				url:'ranking_dayAjax.do?direction=right&dDay='+$('#dDay').html(),
				dataType:'json',
				success:function(list){
					console.log(list[0].rank);
					let html = '';
