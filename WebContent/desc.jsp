	...
	<section class="banner-area relative">
		...
		<div class="container">
			<div class="row justify-content-between align-items-center text-center banner-content">
				<div class="col-lg-12">
					<h1 class="text-white">제품 소개</h1>
					<p>당신을 위한 맞춤 타임테이블 LED알람 스탠드</p>
				</div>
			</div>
		</div>
	</section>
			...
			<div class="row feature_inner">
				...
				<div class="col-lg-3 col-md-6">
					<div class="feature-item">
						...
						<h4>자동 밝기 조절</h4>
						<p>주변 환경에 따라 밝기가 자동<br> 조절되어 시력 보호 효과 UP</p>
			...
			<div class="row align-items-center justify-content-center">
				...
				<div class="col-lg-5 col-md-12 about-right">
					<div class="section-title text-left">
						<h4>Valkyrie</h4>
						<h2>LED알람<br/>스마트스탠드</h2>
					</div>
					<div>
						<p>
							집중력 저하의 주요원인은 스마트폰을 들여다보는 것! <br>
							스마트폰이나 별도의 장치 없이 공부 시간 알람 설정이 가능하고 <br>
							눈의 피로도를 줄여줄 수 있는 스마트스탠드 <br>
							발키리를 만나보세요.
						</p>
					</div>
					<c:choose>
					...
					<div class="row">
						<div class="col-lg-6 col-md-6">
							<div class="single-offer">
								...
								<p>
									1. 회원가입 후 학습시간과 쉬는 시간을 설정합니다. <br>
									2. 나의 학습 시간은 학습 현황 페이지에서 확인할 수 있습니다.
									<br><br><br>
								</p>
							</div>
						</div>
						...
						<div class="col-lg-6 col-md-6">
							<div class="single-offer">
								...
								<p>
									1. 마이페이지에서 공부 시작 버튼을 누르면 타이머가 자동으로 전송됩니다. <br>
									2. 설정한 학습 시간이 지나면, 쉬는 시간에 맞는 조명이 밝혀집니다.
									3. 공부가 끝나면, 일시정지 버튼을 눌러 일반 스탠드/무드등처럼 사용이 가능합니다.
								</p>
							</div>
						</div>
						...
						<div class="col-lg-6 col-md-6">
							<div class="single-offer">
								...
								<p>
									1. 스탠드에 부착된 버튼으로 자동 밝기 조절/수동 밝기 조절 모드를 선택할 수 있습니다.
								</p>
							</div>
						</div>
			...
			<div class="row">
				<div class="active-testimonial">
					<div class="single-testimonial item d-flex flex-row">
						...
						<div class="desc">
							<p>
								저도 같은 공부로 힘든 시절을 보낸 사람으로, 제가 공부할 때 이 제품이 있었으면
								지금쯤 더 높은 위치에 있었을텐데 호호호..
							</p>
							<h4>김예인</h4>
							<div class="bottom">
								<p>팀장 & 아두이노</p>
					...
					<div class="single-testimonial item d-flex flex-row">
						...
						<div class="desc">
							<p>
								백엔드 코드...정말 쉬웠어요. 쉽지만 꽉차고 알찬 기능!! 다 제 능력이죠. 다른 회사 이사님들
								많이 봐주세요 ^^
							</p>
							<h4>신은정</h4>
							<div class="bottom">
					...
					<div class="single-testimonial item d-flex flex-row">
						...
						<div class="desc">
							<p>
								공부하는 사람들에게 정말 강추합니다. 버튼 몇 개로 공부시간을 정리해주고
								누적해주다니... 이런 제품 어디없습니다.
							</p>
							<h4>정다운</h4>
							<div class="bottom">
					...
					<div class="single-testimonial item d-flex flex-row">
						...
						<div class="desc">
							<p>
								이거 만들기 정말 힘들었어요. 얼마나 자식같은 존재인지.... 이 제품에 있는 기능
								좋아요...좋습니다
							</p>
							<h4>오현종</h4>
							<div class="bottom">
					...
					<div class="single-testimonial item d-flex flex-row">
						...
						<div class="desc">
							<p>
								집에서 혼자 공부하기 정말 힘들어요. 그런데 이 제품과 같이 공부하면서
								누적되는 시간과 통계가 눈에 보이니 동기부여가 많이 됐어요!
							</p>
							<h4>도한재</h4>
							<div class="bottom">
								<p>프론트엔드</p>
