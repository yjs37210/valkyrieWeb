...
<body>
			...
			<div class="row">
				<div class="rank-title">
					...
					<div class="rank-title-b">
						...
						<span><h3><span id='sWeek'>${sWeek}</span> ~ <span id='eWeek'>${eWeek}</span></h3></span>
	...
	$(function(){
		$('#left').on('click',function(){
			$.ajax({
				url:'ranking_weekAjax.do?direction=left&sWeek='+$('#sWeek').html(),
				dataType:'json',
				success:function(list){
					...
					let html = '';
					 for(let i = 0; i < list.length; i++){
						 ...
						 html += '<td class="tg-3yw0"> '+list[i].wTime+'</td>';
						 html += '</tr>';
					 }
					 console.log(html);
					 $('#rankingList').html(html);
					 $('#sWeek').html(list[0].sWeek);
					 $('#eWeek').html(list[0].eWeek);
	...
	$(function(){
		$('#right').on('click',function(){
			$.ajax({
				url:'ranking_weekAjax.do?direction=right&sWeek='+$('#sWeek').html(),
				dataType:'json',
				success:function(list){
					console.log(list[0].rank);
					let html = '';
