	...
	<section class="contact_area section-gap">
		<div class="row">
			<div class="col-md-7 mb-5">
				...
				<form action="boardAnswerContent.do" class="p-5 bg-white"
					method="get">
					...
					<div class="row form-group name">
						<div class="col-md-6 mb-3 mb-md-0">
							<label class="text-black" for="fname">닉네임</label> <input
								type="text" id="fname" class="form-control"
								value="${vo.nickName}" readonly>
						</div>
					</div>
					...
					<div class="row form-group">
						...
						<div class="col-md-12">
							<label class="text-black" for="subject">제목</label> <input
					...
					<div class="row form-group">
						...
						<c:if test="${!empty vo.a_content}">
							<div class="col-md-12">
								<hr>
								<label class="text-black" for="message">답변</label>
								<textarea id="message" cols="30" rows="7" class="form-control"
									name="a_content" readonly>${vo.a_content}</textarea>
							</div>
						</c:if>
						<!-- <div class="col-md-12" id="delete">
							<label class="text-black" for="bPw">비밀번호</label>
							<input type="password" id="bPw" name="bPw" class="form-control">
						</div> -->
					</div>
